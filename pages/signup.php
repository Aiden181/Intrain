...
<body>
    <div class="container-sm fadeInDown" id="signup-form">
        <form action="index.php?p=signup" method="post" onsubmit="return checkSignup()" id="customer-signup">
            <h1>Sign Up</h1>
            ...
            <div class="form-group">
                <input type="password" class="form-control fadeIn third" id="password" name="password" placeholder="Enter password" value="<?php echo isset($_POST['password']) ? test_input($_POST['password']) : ''; ?>" required>
            </div>
